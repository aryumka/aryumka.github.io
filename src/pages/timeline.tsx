...
const PostContent = styled.div<{ recent: boolean }>`
  ...
  &::after {
    background: ${props => (props.recent ? '#9966FF' : '#888')};
    ...
    box-shadow: ${props => (props.recent ? 'rgb(204, 153, 255) 0px 0px 0px 0px' : 'none')};
    animation: ${props =>
    ...
    @keyframes pulse {
      0% {
        ...
        box-shadow: rgba(204, 153, 255, 0.7) 0px 0px 0px 0px;
      }
      70% {
        transform: scale(1);
        box-shadow: rgba(204, 153, 255, 0) 0px 0px 0px 10px;
      }
      100% {
        transform: scale(0.95);
        box-shadow: rgba(204, 153, 255, 0) 0px 0px 0px 0px;
      }
    }
  }
`;
